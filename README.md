...
.agent-workflow/self-evolution/    # local repo/process improvement memory
.goals/                            # portable, committable goal spec
~/.goals/user/                      # private global user preference memory
```
...
goals user show | record | import-insights | interview | forget
